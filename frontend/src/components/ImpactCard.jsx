const ImpactCard = ({data, symbol}) => {
    if(!data || data.length === 0){
        return(
            <div className="bg-white rounded-lg shadow-sm p-4 flex items-center justify-center h-40">
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm p-4 h-full">
            ...
            <div className="space-y-3">
                ...
                <div className={`flex justify-between items-center py-3 px-3 rounded-lg mt-2 ${impacto >= 0 ? 'bg-green-50' : 'bg-red-50'}`}>
